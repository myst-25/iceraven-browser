...
![Version](https://img.shields.io/badge/version-2.31.0-blue.svg)
![Fenix Version](https://img.shields.io/badge/Fenix-138.0-orange.svg)
![License](https://img.shields.io/badge/license-MIT-green.svg)
![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)

A powerful, priv2.34.0cy-focused browser for Android devices, built on Mozilla's GeckoView engine.
...
Iceraven Browser is a feature-rich, priv2.34.0cy-focused web browser for Android devices. Built on Mozilla's powerful GeckoView engine, it offers adv2.34.0nced customization options, extended add-on support, and enhanced priv2.34.0cy features.

## 🚀 Features

### 🔧 Adv2.34.0nced Configuration

- Full access to `about:config` for deep browser customization
- Fine-tuned browsing experience
- Customizable interface elements

### 🧩 Extended Add-on Support

- Access to a wide range of Firefox add-ons from AMO
- Ability to request additional add-ons
...
### 🛡️ Priv2.34.0cy Control

- Option to disable recently visited websites
- Enhanced priv2.34.0cy features
- Customizable tracking protection

### 🏗️ GeckoView Engine

- Built on Mozilla's powerful engine
...
- [View Release Notes](https://github.com/fork-maintainers/iceraven-browser/releases/tag/iceraven-2.34.0)

### Supported Architectures

- **ARM64-v2.34.0**: 64-bit ARM devices
- **ARM-v2.34.0**: 32-bit ARM devices
...
- Node.js (v2.34.0 or higher)
- npm (v2.34.0 or higher)
- Git
...
<div align="center">
<a href="https://github.com/fork-maintainers">
  <img src="https://github.com/fork-maintainers.png" width="50" height="50" alt="fork-maintainers"/>
</a>
<a href="https://github.com/myst-25">
  <img src="https://github.com/myst-25.png" width="50" height="50" alt="myst-25"/>
</a>
</div>
...
<div align="center">
Made with ❤️ by the Iceraven Team
</div>
